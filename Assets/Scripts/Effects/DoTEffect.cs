...
public class DoTEffect : Effect
{
    ...
    ) : base(target, duration, damagePerTick, maxStacks, interval, stackBehavior, attacker)
    {
    ...
    protected override void Apply()
    {
        ...
        _health.TakeDamage(this.StackBehavior == StackBehavior.RefreshDuration ? value * stacks : value, _damageType, attacker);
    }
}